...
@Configuration
@EnableAerospikeRepositories(basePackageClasses = AerospikeUsersReactiveRepository.class,
        includeFilters = @ComponentScan.Filter(UsersReactiveRepository.class),
        aerospikeTemplateRef = "aerospikeReactiveTemplateUsers")
public class AerospikeUsersConfiguration extends AbstractReactiveAerospikeDataConfiguration {
    @Override
    ...
    @Bean(name = "aerospikeReactiveTemplateUsers")
    public ReactiveAerospikeTemplate aerospikeReactiveTemplateUsers(MappingAerospikeConverter mappingAerospikeConverter,
